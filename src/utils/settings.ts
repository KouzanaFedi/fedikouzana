...
export const PORTFOLIO_SOURCE_CODE = "https://github.com/KouzanaFedi/fedikouzana";
export const GITHUB_URI = "https://github.com/KouzanaFedi";
export const UPWORK_URI = "https://upwork.com/freelancers/fedik";
